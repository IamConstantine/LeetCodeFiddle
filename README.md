...
5. [Robot Room Cleaner](https://leetcode.com/problems/robot-room-cleaner) - visited all directions but always only use turnRight().
...
4. [Largest And Combination](https://leetcode.com/problems/largest-combination-with-bitwise-and-greater-than-zero) - find the max number of elements set any bit position.

### Maths

1. [Count Latice Points](https://leetcode.com/problems/count-lattice-points-inside-a-circle) - use distance formula to find all the points that lie within the radius of a circle.
