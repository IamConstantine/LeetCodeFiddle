...
with open("./inputs/ExtendedPolymerization", "rt") as file:
...
def polymerization(molecule: str, rules: List[Tuple[str, str]], steps: int) -> str:
    ...
    if steps > 10:
        print(
            "Sorry. This isn't going to work for Part 2, because memory usage grows exponentially with the number of steps.")
        return
